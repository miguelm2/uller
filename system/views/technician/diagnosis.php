...
<body>
    ...
    <main id="main" class="main">
            ...
            <div class="row">
                <div class="card">
                    ...
                    <div class="card-body" style="padding-top: 5px;">
                        <div class="col-md-12">
                                ...
                                <textarea class="form-control" rows="3" disabled><?= $diagnostico->getDescripcion(); ?></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-9">
                                <h5 class="text-primary">Ayudantes</h5>
                            </div>
                            <div class="col-md-3 text-right d-grid">
                                <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#addAssistant"><i class="bi bi-plus-square"></i> Agregar Ayudante</button>
                            </div>
                        </div>
                    </div>
                    <div class="card-body" style="padding-top: 5px;">
        ...
        <!-- ======= Modal Ayudante ======= -->
        <form method="POST">
            <div class="modal fade" id="addAssistant" tabindex="-1">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Agregar Ayudante</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <div class="col-md-12 form-group">
                                <label for="ayudante">Ayudante</label>
                                <select class="form-select" name="ayudante" id="ayudante">
                                    <?= $selectAyudantes; ?>
                                </select>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><i class="bi bi-x-circle"></i> Cerrar</button>
                            <button type="submit" name="addAssistant" class="btn btn-primary"><i class="bi bi-check-circle"></i> Agregar Ayudante</button>
                        </div>
                    </div>
                </div>
            </div>
