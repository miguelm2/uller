                        ...
                        <form method="POST">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" class="form-control" name="serial" maxlength="150" required>
                                </div>
                                <div class="col-md-6 form-group">
                                    <label for="year_compra">Año de compra</label>
                                    <input type="text" class="form-control" name="year_compra" maxlength="4" required>
                                </div>
                                <div class="col-md-6 form-group">
                                    <label for="voltaje">Voltaje</label>
                                    <input type="number" class="form-control" name="voltaje" required>
                                </div>
                                <div class="col-md-6 form-group">
                                    <label for="amperaje">Amperaje</label>
                                    <input type="number" class="form-control" name="amperaje" required>
                                </div>
                                <div class="col-md-6 form-group">
                                    <label for="fases">Fases</label>
                                    <input type="number" class="form-control" name="fases" required>
                                </div>
