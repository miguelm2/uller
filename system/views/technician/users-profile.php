                            ...
                            <div class="tab-content pt-2">
                                ...
                                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-8"><?= $perfilTecnico->getTipo() ?></div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <form method="POST">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <input name="nombre" type="text" class="form-control" value="<?= $perfilTecnico->getNombre() ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <input name="correo" type="text" class="form-control" value="<?= $perfilTecnico->getCorreo() ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <input name="telefono" type="number" class="form-control" value="<?= $perfilTecnico->getTelefono() ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <input name="cedula" type="number" class="form-control" value="<?= $perfilTecnico->getCedula() ?>">
                                            </div>
                                        </div>
