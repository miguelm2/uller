...
<body>
    ...
    <main id="main" class="main">
        ...
        <!-- ======= Basic Modal ======= -->
        <form method="POST">
            <div class="modal fade" id="newTools" tabindex="-1">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Nueva Herramienta / Equipo</h5>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" name="newTool" class="btn btn-success"><i class="bi bi-plus-square"></i> Nueva Herramienta</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <form method="POST" id="form_tool">
            <div class="modal fade" id="editTools" tabindex="-1">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Editar Herramienta / Equipo</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-12 form-group">
                                    <label for="tipo">Tipo</label>
                                    <select class="form-select" name="tipo_tool" id="tipo_tool">
                                        <option value="1">Herramienta</option>
                                        <option value="2">Equipo</option>
                                    </select>
                                </div>
                                <div class="col-md-12 form-group">
                                    <label for="descripcion">Descripcion</label>
                                    <textarea class="form-control" name="descripcion_tool" id="descripcion_tool" rows="3" maxlength="255" required></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                            <button type="submit" name="setTool" class="btn btn-success"><i class="bi bi-save"></i> Editar Herramienta</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="col-md-12 form-group">
                                <input type="hidden" class="form-control" name="id_herramienta" id="id_herramieta_delete" readonly required>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                            <button type="submit" name="deleteTool" class="btn btn-danger"><i class="bi bi-trash-fill"></i> Eliminar Registro</button>
                        </div>
                    </div>
                </div>
            </div>
