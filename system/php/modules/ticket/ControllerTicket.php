...
if(isset($_POST['newInformTicket'])){
    ...
    $response = ServiceTicket::newInformTicket($_GET['ticket'], $_POST['id_tipo'], $_POST['fecha_servicio'],
                                            ...
                                            $_POST['repuestos'],$_POST['insumos'],$tarjeta_electronica,$_POST['estimado_horas'],$_POST['observaciones']);
}
