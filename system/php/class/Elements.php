...
class Elements
{
    ...
    public static function crearBotonVerTwoLinkEditar($link1, $valor1, $link2, $valor2)
    {
        return '<a href="' . $link1 . '?' . $link1 . '=' . $valor1 . '&' . $link2 . '=' . $valor2 . '" class="btn btn-info rounded-circle btn-sm"><i class="bi bi-pen-fill"></i></a>';
    }
