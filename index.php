...
<head>
  ...
  <title>Pagina web - Kondory Tecnologia</title>
...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index">ULLER</a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="getstarted scrollto" href="system/views/page/login">Ingresar</a></li>
        </ul>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
            <form method="post" class="php-email-form">
              ...
              <div class="text-center"><button type="submit" name="newMessage">Enviar</button></div>
            </form>
          </div>
